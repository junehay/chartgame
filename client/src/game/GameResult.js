...
import { nextButtonState } from '../store';
...
const Result = () => {
  ...
  const nextButton = useRecoilValue(nextButtonState);
        ...
        <Fade in={open}>
          <Div>
            <Card className={classes.card}>
              <TitleBox>
                <Typography variant="h6" style={{ fontFamily: 'auto', color: 'white' }}>
                  게임 결과
                </Typography>
              </TitleBox>
              ...
              <CardContent style={{ display: 'flex', height: '280px' }}>
                ...
                <div style={{ width: '60%', float: 'left' }}>
                  ...
                  <Typography variant="button" display="block" style={style} gutterBottom>
                  ...
                  <br />
                  <input ref={nameInput} maxLength={8} style={{ width: '110px' }} />
                  <Button size="small" variant="outlined" style={{ marginLeft: '10px' }} onClick={rankSet}>
                    등록
                  </Button>
                </div>
              </CardContent>
